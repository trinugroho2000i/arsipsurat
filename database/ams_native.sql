...
--
-- Host: localhost
-- Waktu pembuatan: 04. Juli 2018 jam 16:38
-- Versi Server: 5.0.67
-- Versi PHP: 5.2.6
...
(1, 'TextCode - Free Script Web', 'TextCode - Free Script Web', 'Aktif', 'textcode.blogspot.com', 'Firdaus', '1210031802', 'https://textcode.blogspot.com', 'jundialfaruqi@gmail.com', 'logo.png', 1);
...
CREATE TABLE IF NOT EXISTS `tb_jns_pembayaran` (
...
--
-- Struktur dari tabel `tb_sppjb`
--

CREATE TABLE IF NOT EXISTS `tb_sppjb` (
...
--
-- Dumping data untuk tabel `tb_sppjb`
--
